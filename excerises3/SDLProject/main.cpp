...
const char PLAYER_SPRITE_FILEPATH[] = "/Users/aruukebaiakmatova/Desktop/CS3113/excerises3/assets/sonic.png",
           FRAME_SPRITE_FILEPATH[]  = "/Users/aruukebaiakmatova/Desktop/CS3113/excerises3/assets/frame.png",
           FONT_SPRITE_FILEPATH[]   = "/Users/aruukebaiakmatova/Desktop/CS3113/excerises3/assets/font1.png";
...
void update()
{
    ...
    float frame_per_second = (float) 1 / FRAMES_PER_SECOND;
    
    if (g_skey_pressed) {
        if (g_animation_time >= frame_per_second) {
            g_animation_time = 0.0f;
            g_animation_index++;
            if (g_animation_index >= 4) {
                g_animation_index = 0;
            }
        }
    }
