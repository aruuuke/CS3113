...
enum EntityType { PLATFORM, PLAYER, ENEMY, GOLD   };
...
private:
    ...
    glm::mat4 m_model_matrix;
     ...
     float RADIUS = 0.5f;      // radius of your circle
     float ROT_SPEED = 0.008f;  // rotational speed
...
//        };
    ...
    int        const get_activity_status()      const { return m_is_active; };
    int        const get_health()      const { return health; };
    bool        const get_attacking()                     const  {return m_is_attacking;};
    ...
    void const set_attacking(bool new_attacking)                     { m_is_attacking = new_attacking;};
    void const set_total_gold(int new_total_gold)                  {m_total_gold = new_total_gold;};
