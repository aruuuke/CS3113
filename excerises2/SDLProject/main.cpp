...
const char FLOWER_SPRITE[] = "/Users/aruukebaiakmatova/Desktop/CS3113/excerises2/assets/flower_example.gif";
...
glm::vec3 g_flower_movement = glm::vec3(0.0f, 0.0f, 0.0f);     //
                                                               //
glm::vec3 g_flower_orientation = glm::vec3(0.0f, 0.0f, 0.0f);  //
glm::vec3 g_flower_rotation    = glm::vec3(0.0f, 0.0f, 0.0f);  //
                                                               //
...
void update()
{
    ...
    /** ———— ROTATING SPRITE ———— **/
    // inc rotation angle
    g_rot_angle += DEGREES_PER_SECOND * delta_time;
    // update position to move the flower
    g_flower_position += g_flower_movement * g_flower_speed * delta_time;
